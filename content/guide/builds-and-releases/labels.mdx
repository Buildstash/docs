...
- Specify labels when creating the release either [via web interface](/using-releases) or [via API](/api)
- Likewise labels can be updated on existing releases [via web](/using-releases) or [via API](/api)
...
Labels can be a powerful tool to quickly filter for [relevant builds](/builds-and-releases#sorting-and-searching) or [releases](/using-releases).