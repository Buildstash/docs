...
<Steps>
  <Step title="Request to start upload" icon="chevron-right" stepNumber={1}>
    ...
    <Cards>
      <Card title="/upload/request" icon={<SquareTerminal />} horizontal href="/api-reference/endpoint/upload/request">
      </Card>
    </Cards>
  </Step>
</Steps>
...
Alternatively, if your primary build file is larger than 5GB, you must upload as multiple parts. Your original upload request will also return a chunked_upload boolean indicating whether multipart upload is advised and available for this build.
  ...
  <Steps>
    ...
    <Cards>
      <Card title="/upload/request/multipart" icon={<SquareTerminal />} horizontal href="/api-reference/endpoint/upload/request-multipart">
      </Card>
    </Cards>
    </Step>
  ...
  ### Verify and complete
    ...
    <Steps>
      <Step title="Verify and complete upload" icon="chevron-right" stepNumber={4}>
        ...
        <Cards>
          <Card title="/upload/verify" icon={<SquareTerminal />} horizontal href="/api-reference/endpoint/upload/verify">
          </Card>
        </Cards>
