---
title: "Upload Guide"
description: "Complete guide to uploading files to Buildstash"
---

# Upload Guide

This guide demonstrates how to upload files to Buildstash using both single part and multipart upload methods.

## Prerequisites

- Buildstash API key
- File to upload
- HTTP client (curl, axios, etc.)
