...
<Steps>
  <Step title="Include expansion file details in initial start upload request" icon="chevron-right" stepNumber={1}>
    When you call [/upload/request](/api-reference/endpoint/upload/request) endpoint above, you'll include the expansion file details there, and receive the presigned URL to upload to, similarly to with the primary file.
  </Step>
